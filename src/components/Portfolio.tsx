...
export const Portfolio = () => {
  return (
    <div className="w-full h-[auto] max:h-[100vh] bg-no-repeat flex flex-col bg-auto bg-gray-300 bg-center items-center pt-[2.5rem] max:pt-[4.525rem] ultra:bg-none ultra:pt-32">
